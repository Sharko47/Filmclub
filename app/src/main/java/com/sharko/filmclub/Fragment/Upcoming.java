...
public class Upcoming extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        movieRecyclerView = rootView.findViewById(R.id.upcomingRecyclerView);

        swipeRefreshLayout = rootView.findViewById(R.id.swipeToRefreshUpcoming);
    ...
    private void loadJson() {
        try {
            ...
            Call<MovieDbResponse> movieDbResponseCall = retrofitService.getUpcomingMovies(API_KEY);
